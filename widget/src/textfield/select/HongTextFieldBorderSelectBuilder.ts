...
> {
  ...
  labelTypo(typo: HongTypoProps): HongTextFieldBorderSelectBuilder {
  ...
  placeholderTypo(typo: HongTypoProps): HongTextFieldBorderSelectBuilder {
  ...
  helperTextTypo(typo: HongTypoProps): HongTextFieldBorderSelectBuilder {
