export const HongWidgetType = {
  ...
  TEXT_FIELD_BORDER_SELECT:{ value: 'TextFieldBorderSelect',allowPlayground: true  },
  ...
  SCROLL_FADE_ANIM_LAYOUT: { value: 'ScrollFadeAnimLayout', allowPlayground: false },
...
export function stringToHongWidgetType(value: string | null | undefined): HongWidgetTypeEntry {
  return Object.values(HongWidgetType).find(
